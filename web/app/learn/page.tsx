  ...
  return (
    <div className="flex min-h-full flex-col bg-stone-50">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-4 px-4 py-6">
        <h1 className="text-2xl font-bold tracking-tight text-stone-900">Learn</h1>
        <p className="text-sm text-stone-600">
          Short guides on what to know before adopting in Singapore. Full deep-dives are coming —
          for now, each guide is a one-page summary.
        </p>
